...
| 3 — control plane | Policy API, audit log, approval workflow, dashboard | **in progress** — local read-only dashboard (`agentguard dashboard`) shipped; hosted team API designed |
