        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-3">
          <div>
            ...
            <CodeBlock>
              ...
              <span className="text-card-foreground">npx agentguard audit</span>
            </CodeBlock>
          </div>
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              ...
              audited it, AgentGuard tells you before your agent runs it.
            </p>
            <CodeBlock>
              <span className="text-muted-foreground">{"# agentguard.lock"}</span>
              {"\n"}
